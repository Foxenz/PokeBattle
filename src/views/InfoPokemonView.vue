        ...
        <v-row>
          ...
          <v-col cols="12" md="6" class="bg-blue-grey-darken-2 mb-1">
            <v-card class="ma-2 pa-2 bg-blue-grey-darken-1">
              <v-img :src="pokemonInfo.sprites.front_default" cover class="bg-blue-grey-darken-4">
              ...
              <v-card class="my-2 bg-blue-grey-darken-4">
                <v-card-title>
                  ...
                  <v-sheet class="bg-blue-grey-darken-4">
                    <p class="font-weight-regular text-caption">Height: {{ pokemonInfo.height }} in</p>
                    <p class="font-weight-regular text-caption">Weight: {{ pokemonInfo.weight }} kg</p>
                  </v-sheet>
                </v-card-title>
              </v-card>
              <v-card class="my-2 bg-blue-grey-darken-4">
          ...
          <v-col cols="12" class="bg-blue-grey-darken-2">
            <v-card class="my-2 bg-blue-grey-darken-4">
              <v-card-title>
                ...
                <v-sheet class="bg-blue-grey-darken-4" v-for="stat in statPercentages" :key="stat.name">
                  <p class="text-caption text-capitalize">{{ stat.name }}</p>
                  <v-progress-linear v-model="stat.percentage" color="amber" height="25" class="my-1">
